...
import withActiveGenres from '../../hocs/with-active-genres/with-active-genre.jsx';
import GenresList from '../genres-list/genres-list.jsx';

const GenresListWrapped = withActiveGenres(GenresList);
  ...
  return <React.Fragment>
    ...
    <div className="page-content">
      <section className="catalog">
        ...
        <GenresListWrapped moviesList={moviesList} activeGenre={`All genres`} onGenreClick={()=>{}}/>
